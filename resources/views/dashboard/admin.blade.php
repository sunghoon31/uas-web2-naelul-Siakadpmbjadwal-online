    ...
    <div class="dashboard-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <p class="mb-1 opacity-90">Selamat datang, <strong>{{ Auth::user()->name }}</strong>!</p>
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="stat-value" data-stat="totalMahasiswa">{{ $stats['total_mahasiswa'] }}</h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card success">
                ...
                <h3 class="stat-value" data-stat="totalDosen">{{ $stats['total_dosen'] }}</h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card warning">
                ...
                <h3 class="stat-value" data-stat="calonPending">{{ $stats['calon_mahasiswa_pending'] }}</h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card info">
                ...
                <h3 class="stat-value">{{ $stats['total_prodi'] }}</h3>
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="stat-value">{{ $stats['total_fakultas'] }}</h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card success">
                ...
                <h3 class="stat-value">{{ $stats['total_mata_kuliah'] }}</h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card warning">
                ...
                <h3 class="stat-value">{{ $stats['total_ruangan'] }}</h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card info">
                ...
                <h3 class="stat-value">{{ $stats['total_jadwal'] }}</h3>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody id="tableMahasiswaTerbaru">
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-custom bg-primary">{{ $mhs->angkatan }}</span></td>
...
$(document).ready(function() {
    ...
    // Chart Gender
    const genderData = {!! json_encode($mahasiswaPerGender) !!};
    ...
    new Chart(document.getElementById('chartAngkatan'), {
        type: 'line',
        data: {
            labels: {!! json_encode($mahasiswaPerAngkatan->pluck('angkatan')) !!},
            datasets: [{
                label: 'Jumlah Mahasiswa',
                data: {!! json_encode($mahasiswaPerAngkatan->pluck('total')) !!},
                borderColor: '#4facfe',
    ...
    const calonData = {!! json_encode($calonMahasiswaStatus) !!};
    const statusLabels = {
        'pending': 'Pending',
        'diterima': 'Diterima',
        'ditolak': 'Ditolak'
    ...
    let lastMahasiswaCount = {{ $stats['total_mahasiswa'] }};
