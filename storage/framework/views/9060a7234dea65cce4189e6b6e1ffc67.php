        ...
        <div class="tab-pane fade show active" id="fakultas" role="tabpanel">
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="<?php echo e(route('fakultas.export')); ?>" class="btn btn-sm btn-success">
        ...
        <div class="tab-pane fade" id="prodi" role="tabpanel">
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="<?php echo e(route('prodi.export')); ?>" class="btn btn-sm btn-success">
                        <i class="bi bi-file-earmark-excel"></i> Export
                    </a>
...
$(function () {
    ...
    fakultasTable = $('#fakultasTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('fakultas.index')); ?>",
        order: [[1, 'asc']],
        scrollX: false,
        autoWidth: false,
        columns: [
    ...
    prodiTable = $('#prodiTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('prodi.index')); ?>",
        order: [[1, 'asc']],
        scrollX: false,
        autoWidth: false,
        columns: [
    ...
    function loadFakultasOptions() {
        $.get("<?php echo e(route('prodi.create')); ?>", function(data) {
    ...
    $('#formFakultas').submit(function(e) {
        ...
        let url = id ? `/fakultas/${id}` : "<?php echo e(route('fakultas.store')); ?>";
    ...
    $('#formProdi').submit(function(e) {
        e.preventDefault();
        let id = $('#prodi_id').val();
        let url = id ? `/prodi/${id}` : "<?php echo e(route('prodi.store')); ?>";
        let submitBtn = $(this).find('button[type="submit"]');
    ...
    $('#formImportFakultas').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('fakultas.import')); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#formImportProdi').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('prodi.import')); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/akademik/index.blade.php ENDPATH**/ ?>