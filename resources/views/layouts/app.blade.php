...
<head>
    ...
    <title>{{ config('app.name', 'SIAKAD') }} - @yield('title', 'Dashboard')</title>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <ul class="nav flex-column">
                ...
                @if(Auth::user()->role === 'admin')
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('pmb.calon-mahasiswa.dashboard') ? 'active' : '' }}" href="{{ route('pmb.calon-mahasiswa.dashboard') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('pmb.calon-mahasiswa.*') && !request()->routeIs('pmb.calon-mahasiswa.dashboard') ? 'active' : '' }}" href="{{ route('pmb.calon-mahasiswa.index') }}">
