...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        <a href="<?php echo e(route('mahasiswa.export')); ?>" class="btn btn-success">
...
<!-- MODAL UNTUK CREATE/EDIT/SHOW -->
<div class="modal fade" id="mahasiswaModal" tabindex="-1" data-bs-backdrop="static">
            ...
            <form id="formImport" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Format: NIM | Nama | Angkatan | Program Studi</small>
                    </div>
                    <div class="alert alert-info">
                        <strong>Template Excel:</strong><br>
                        Header: <code>nim | nama | angkatan | program_studi</code>
                    </div>
                </div>
...
$(function () {
    ...
    let table = $('#mahasiswaTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('mahasiswa.index')); ?>",
        order: [[2, 'asc']],
        columns: [
    ...
    $('#btn-create').click(function () {
        $.get("<?php echo e(route('mahasiswa.create')); ?>", function(data) {
    ...
    $('#formImport').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('mahasiswa.import')); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/mahasiswa/index.blade.php ENDPATH**/ ?>