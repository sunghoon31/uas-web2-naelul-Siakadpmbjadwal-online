        ...
        <div class="modal-content">
            ...
            <form id="formImport" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <a href="<?php echo e(route('ruangan.template')); ?>" class="btn btn-sm btn-success w-100">
...
$(document).ready(function() {
    ...
    const table = $('#tableRuangan').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('ruangan.index')); ?>",
        columns: [
    ...
    $('#formRuangan').submit(function(e) {
        ...
        const url = id ? `/ruangan/${id}` : "<?php echo e(route('ruangan.store')); ?>";
    ...
    $('#formImport').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('ruangan.import')); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#btnExportExcel').click(function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php echo e(route('ruangan.export')); ?>";
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil!',
    ...
    $('#btnExportPdf').click(function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php echo e(route('ruangan.export.pdf')); ?>";
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil!',
                    text: 'File sedang didownload...',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/ruangan/index.blade.php ENDPATH**/ ?>