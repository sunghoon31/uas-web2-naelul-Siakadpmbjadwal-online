    ...
    <div class="row">
        ...
        <div class="col-md-4">
                ...
                <div class="card-body">
                    <table class="table table-sm table-borderless info-mahasiswa-table">
                        ...
                        <tr>
                            <th>Jalur Masuk</th>
                            <td>
                                <span class="badge badge-info badge-custom"><?php echo e(ucfirst($calonMahasiswa->jalur_masuk)); ?></span>
                            </td>
                        </tr>
                        <tr>
                            <th>Status</th>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($calonMahasiswa->status_seleksi == 'pending'): ?>
                                <span class="badge badge-warning badge-custom text-dark">Pending</span>
                                <?php elseif($calonMahasiswa->status_seleksi == 'diterima'): ?>
            ...
            <div class="card mt-3 shadow-sm border-0">
                <div class="card-body">
                    <a href="<?php echo e(route('pmb.calon-mahasiswa.index')); ?>" class="btn btn-secondary btn-block btn-action shadow-sm">
...
<script>
const calonMahasiswaId = <?php echo e($calonMahasiswa->id); ?>;
let keuanganData = [];
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/keuangan-pmb/show.blade.php ENDPATH**/ ?>