...
<header class="nav">
    <div class="brand">
        <img src="<?php echo e(asset('storage/aether/logo.png')); ?>" class="logo" alt="Aetheris Logo">
...
<!-- HERO -->
<section class="hero">
    <div class="hero-bg" style="background-image:url('<?php echo e(asset('storage/aether/hero-campus.jpg')); ?>'); background-size: cover; background-position: center;"></div>
...
<section class="campus reveal">
    ...
    <div class="campus-gallery">
        <div class="campus-img">
            <img src="<?php echo e(asset('storage/aether/campus-1.jpg')); ?>" alt="Campus 1">
        </div>
        <div class="campus-img">
            <img src="<?php echo e(asset('storage/aether/campus-2.jpg')); ?>" alt="Campus 2">
        </div>
        <div class="campus-img">
            <img src="<?php echo e(asset('storage/aether/campus-3.jpg')); ?>" alt="Campus 3">
        </div>
    </div>
</section>
...
</html><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/welcome.blade.php ENDPATH**/ ?>