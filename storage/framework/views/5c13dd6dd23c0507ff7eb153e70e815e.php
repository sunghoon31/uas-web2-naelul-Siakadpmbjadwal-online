...
$(function() {
    ...
    const table = $('#tableData').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('mata-kuliah.index')); ?>",
        columns: [
    ...
    // Load Prodi
    function loadProdi() {
        $.get("<?php echo e(route('mata-kuliah.create')); ?>", function(prodis) {
    ...
    $('#formData').submit(function(e) {
        ...
        const id = $('#id').val();
        const url = id ? `/mata-kuliah/${id}` : "<?php echo e(route('mata-kuliah.store')); ?>";
    ...
    $('#btn-export').click(function() {
        window.location.href = "<?php echo e(route('mata-kuliah.export')); ?>";
    });
    ...
    $('#formImport').submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('mata-kuliah.import')); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/mata-kuliah/index.blade.php ENDPATH**/ ?>