...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | MAHASISWA - FIXED VERSION
    |--------------------------------------------------------------------------
    */
    Route::prefix('mahasiswa')->name('mahasiswa.')->group(function () {
        
        // ⚠️ PENTING: Routes dengan kata kunci HARUS di atas route dengan parameter dinamis
        
        // Export routes - Accessible by Admin & Mahasiswa
        ...
        // Import & Create routes - Admin Only (HARUS sebelum routes dinamis)
        Route::middleware(['checkRole:admin'])->group(function () {
            Route::post('import/excel', [MahasiswaController::class, 'import'])->name('import');
            Route::get('create', [MahasiswaController::class, 'create'])->name('create');
        });

        // Index & Show routes - Accessible by Admin & Mahasiswa
        Route::middleware(['checkRole:admin,mahasiswa'])->group(function () {
