...
<div class="container-fluid py-4">
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="mb-0 opacity-75">
                    ...
                    <i class="fas fa-calendar-alt ms-2 me-1"></i><?php echo e(date('l, d F Y')); ?>
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="stat-value" data-stat="totalMahasiswa"><?php echo e($stats['total_mahasiswa'] ?? 0); ?></h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="stat-value" data-stat="totalDosen"><?php echo e($stats['total_dosen'] ?? 0); ?></h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="stat-value"><?php echo e($stats['total_mata_kuliah'] ?? 0); ?></h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card">
                ...
                <h3 class="stat-value"><?php echo e($stats['total_jadwal'] ?? 0); ?></h3>
    ...
    <div class="row">
        <div class="col-12">
            <div class="chart-card">
                <h5 class="chart-title">
                    <i class="fas fa-calendar-day text-primary me-2"></i>Jadwal Kuliah Hari Ini (<?php echo e(['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu'][date('N') - 1]); ?>)
                </h5>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($jadwalHariIni) && $jadwalHariIni->count() > 0): ?>
                    <div class="row">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $jadwalHariIni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 mb-3">
                            <div class="jadwal-card">
                                <div class="jadwal-waktu">
                                    <i class="fas fa-clock me-1"></i>
                                    <?php echo e(date('H:i', strtotime($jadwal->jam_mulai))); ?> - <?php echo e(date('H:i', strtotime($jadwal->jam_selesai))); ?>

                                </div>
                                <h6>
                                    <i class="fas fa-book text-primary me-1"></i>
                                    <?php echo e($jadwal->mataKuliah->nama_mk ?? 'N/A'); ?>

                                </h6>
                                <p class="mb-1">
                                    <i class="fas fa-user text-success me-1"></i> <?php echo e($jadwal->dosen->nama ?? 'N/A'); ?>

                                </p>
                                <p class="mb-0">
                                    <i class="fas fa-door-open text-info me-1"></i> 
                                    <?php echo e($jadwal->ruangan->nama_ruangan ?? 'N/A'); ?> 
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($jadwal->ruangan->kode_ruangan)): ?>
                                        (<?php echo e($jadwal->ruangan->kode_ruangan); ?>)
            ...
            <div class="chart-card">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="<?php echo e(route('mahasiswa.index')); ?>" class="quick-access-btn btn-outline-primary">
                            <i class="fas fa-user-graduate fa-2x d-block"></i>
                            <span class="d-block mt-2">Data Mahasiswa</span>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="<?php echo e(route('dosen.index')); ?>" class="quick-access-btn btn-outline-success">
                            <i class="fas fa-chalkboard-teacher fa-2x d-block"></i>
                            <span class="d-block mt-2">Data Dosen</span>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="<?php echo e(route('jadwal.index')); ?>" class="quick-access-btn btn-outline-info">
                            <i class="fas fa-calendar-alt fa-2x d-block"></i>
                            <span class="d-block mt-2">Jadwal Kuliah</span>
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <a href="<?php echo e(route('mata-kuliah.index')); ?>" class="quick-access-btn btn-outline-warning">
...
$(document).ready(function() {
    ...
    const mahasiswaProdiData = <?php echo json_encode($mahasiswaPerProdi ?? [], 15, 512) ?>;
    ...
    // Chart Angkatan
    const angkatanData = <?php echo json_encode($mahasiswaPerAngkatan ?? [], 15, 512) ?>;
    ...
    function updateRealtimeStats() {
        $.ajax({
            url: '<?php echo e(route("dashboard.realtime")); ?>',
            method: 'GET',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/dashboard/mahasiswa.blade.php ENDPATH**/ ?>