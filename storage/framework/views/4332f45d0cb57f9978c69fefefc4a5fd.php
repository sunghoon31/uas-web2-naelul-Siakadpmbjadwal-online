...
<?php echo $__env->make('calon-mahasiswa.tambah', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
function loadData(page = 1) {
    ...
    $.ajax({
        url: '<?php echo e(route("pmb.calon-mahasiswa.index")); ?>',
        data: params,
...
function approveData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '<?php echo e(url("pmb/calon-mahasiswa")); ?>/' + id + '/approve',
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    'X-Requested-With': 'XMLHttpRequest'
...
function rejectData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '<?php echo e(url("pmb/calon-mahasiswa")); ?>/' + id + '/reject',
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    'X-Requested-With': 'XMLHttpRequest'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\UAS-WEB2\resources\views/calon-mahasiswa/index.blade.php ENDPATH**/ ?>